...
def cons(Variable):
        ...
        y1=  (1 - 0.0025*(Variable[3]+Variable[5]))
        y2=  (1 - 0.0025*(-Variable[3]+Variable[4]+Variable[6]))
        y3=  (1 - 0.01*(-Variable[5]+Variable[7]))
        y4 = ( -100*Variable[0] + (Variable[0]*Variable[5]) - 833.33252*Variable[3] + 83333.33)
        y5 = (-(Variable[1]*Variable[3]) + (Variable[1]*Variable[6]) + 1250*Variable[3] - 1250*Variable[4])
        y6 = (-(Variable[2]*Variable[4]) + (Variable[2]*Variable[7]) + 2500*Variable[4] - 1250000)
